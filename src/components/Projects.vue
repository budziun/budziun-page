  ...
  data() {
    return {
      ...
      projects: [
        {
          id: 'qrcode',
          image: require('@/assets/images/qr2.png'),
        ...
        {
          id: 'avgweather',
          image: require('@/assets/images/avg.png'),
          tags: ['vuejs', 'frontend'],
        ...
        },
        {
          ...
          demo: 'https://quiz-tablice-pl-production.up.railway.app/'
        },
        {
          id: 'uchwalomat',
        ...
        {
          id: 'spotify',
          image: require('@/assets/images/spoti.png'),
          tags: ['react', 'frontend', 'backend'],
          repo: 'https://github.com/budziun/spoti_matcher'
        },
        {
          id: 'quicksearch',
